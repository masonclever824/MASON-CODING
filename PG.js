...
const balls = []
const sound = new Audio("../WAVSounds/collectcoin.mp3")
...
window.addEventListener('keydown', function(e){
    if(e.key == "ArrowUp"){
        player_vel.y = 3
        player.style.backgroundImage = 'url("../Images/playerfront.png")'
    }
    if(e.key == "ArrowDown"){
        player_vel.y = -3
        player.style.backgroundImage = 'url("../Images/playerback.png")'
    }
    if(e.key == "ArrowLeft"){
        player_vel.x = -3
    ...
    if(e.key == "ArrowRight"){
        player_vel.x = 3
        player.style.backgroundImage = 'url("../Images/playerright.png")'
    }
